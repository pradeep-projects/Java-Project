...
import pradeepshah.SpringProject.demo.splitWise.group.Group;
import pradeepshah.SpringProject.demo.splitWise.group.GroupController;
import pradeepshah.SpringProject.demo.splitWise.user.User;
import pradeepshah.SpringProject.demo.splitWise.user.UserController;
...
public class SplitWise {
        ...
        public void demo(){
            ...
            Split split1 = new Split(userController.getUser("U1001"), 300.00);
            Split split2 = new Split(userController.getUser("U2001"), 300.00);
            Split split3 = new Split(userController.getUser("U3001"), 300.00);
            splits.add(split1);
            splits.add(split2);
            splits.add(split3);
            group.createExpense("Exp1001", "Breakfast", 900.00, splits, ExpenseSplitType.EQUAL, userController.getUser("U1001"));

            List<Split> splits2 = new ArrayList<>();
            Split splits2_1 = new Split(userController.getUser("U1001"), 400.00);
            Split splits2_2 = new Split(userController.getUser("U2001"), 100.00);
            splits2.add(splits2_1);
            splits2.add(splits2_2);
            group.createExpense("Exp1002", "Lunch", 500.00, splits2, ExpenseSplitType.UNEQUAL, userController.getUser("U2001"));
